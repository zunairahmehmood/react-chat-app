  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-600 to-red-600 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-md">
        ...
        <button onClick={handleLogin} disabled={loading} className="w-full bg-purple-500 text-white p-2 rounded mb-2 cursor-pointer">
          {loading ? "Loading..." : "Sign In"}
        </button>
        <p className="text-center">Don't have an account? <button onClick={() => navigate("/signup")} className="text-purple-500 underline cursor-pointer">Sign up</button></p>
      </div>
    </div>
  );
};